...
#include "intro_interfaces/msg/detail/led_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const intro_interfaces::msg::LEDState & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: new_state_msg
  cdr << ros_message.new_state_msg;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  intro_interfaces::msg::LEDState & ros_message)
{
  // Member: new_state_msg
  cdr >> ros_message.new_state_msg;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = intro_interfaces::msg::LEDState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const intro_interfaces::msg::LEDState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<intro_interfaces::msg::LEDState *>(
    untyped_ros_message);
...
{
  return &intro_interfaces::msg::typesupport_fastrtps_cpp::_LEDState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, intro_interfaces, msg, LEDState)() {
  return &intro_interfaces::msg::typesupport_fastrtps_cpp::_LEDState__handle;
}
