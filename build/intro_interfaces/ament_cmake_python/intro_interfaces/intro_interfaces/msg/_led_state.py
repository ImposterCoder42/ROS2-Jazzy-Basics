...
class LEDState(metaclass=Metaclass_LEDState):
    ...
    def __init__(self, **kwargs):
        ...
        self.new_state_msg = kwargs.get('new_state_msg', str())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.new_state_msg != other.new_state_msg:
            return False
    ...
    @builtins.property
    def new_state_msg(self):
        """Message field 'new_state_msg'."""
        return self._new_state_msg

    @new_state_msg.setter
    def new_state_msg(self, value):
        if self._check_fields:
            assert \
                isinstance(value, str), \
                "The 'new_state_msg' field must be of type 'str'"
        self._new_state_msg = value
